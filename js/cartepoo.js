        ...
        ajaxGet(this.url, (reponse) => {
            ...
            for (let i = 0; i < results.length; i++) {
                ...
                marker.addEventListener('click', function(e) {
                    ...
                    // marker._icon = "https://raw.githubusercontent.com/pointhi/leaflet-color-markers/master/img/marker-icon-red.png"
                    let status
            ...
            if(veloDispo <= 0) {
                ...
                bookingStepTwo.addEventListener("click", () =>{
                    ...
                    if (autoCompNom.value =="" && autoCompPrenom.value =="") {
                        ...
                        // document.getElementById("canvasBloc").style.backgroundColor = "#e9e9e9"
